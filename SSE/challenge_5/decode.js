...
function checkstr(data) {
  // console.log(data);
  var hash_result = "";
  var pwd_hash = sjcl.hash.sha256.hash(data);
  for (var i = 0; i < 8; i++) {
    hash_result = hash_result + decimalToHexString(pwd_hash[i]);
  }
  if (
    hash_result.toUpperCase() ==
    "B8960D9B21A06734A678D9D960B7A3BF73C81C089DFD7B9070922C2AF6E635A5".toUpperCase()
  ) {
    console.log(
      "Congratulations!!!. You got it!! \n Flag is CTF2021{" + data + "}"
    );
    return 1;
  } else {
    console.log(data);
